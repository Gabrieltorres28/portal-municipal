...
export default function TurnosModal({ isOpen, onClose }: TurnosModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert('Solicitud de turno enviada exitosamente. En producción, esto se enviaría al backend.');
    onClose();
    setFormData({ nombre: '', dni: '', telefono: '', area: '', fecha: '', motivo: '' });
  };
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Solicitá atención para trámites municipales
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="rentas">Rentas y tributos</option>
              <option value="obraspublicas">Obras públicas</option>
              <option value="desarrollo">Desarrollo social</option>
              <option value="inspeccion">Inspección general</option>
              <option value="habilitaciones">Habilitaciones</option>
              <option value="cultura">Cultura y turismo</option>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2">
              El municipio te contactará para confirmar disponibilidad
            </p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describí brevemente el motivo de tu consulta o trámite..."
            />
          </div>
