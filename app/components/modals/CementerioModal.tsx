...
import { X, Church, Upload, Send } from 'lucide-react';
...
export default function CementerioModal({ isOpen, onClose }: CementerioModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert('Solicitud enviada exitosamente. En producción, esto se enviaría al backend.');
    onClose();
    setFormData({ nombre: '', dni: '', telefono: '', tipoSolicitud: '', detalle: '' });
  };
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Solicitudes relacionadas con parcelas y servicios
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="parcela">Consulta sobre parcela</option>
              <option value="nicho">Consulta sobre nicho</option>
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-primary-400 transition-colors cursor-pointer">
              ...
              <p className="text-sm text-gray-600 mb-1">
                Hacé clic para adjuntar documentos
              </p>
